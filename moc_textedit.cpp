...
#include "../qt_nameless/textedit.h"
...
QT_MOC_LITERAL(3, 24, 11) // "returnshell"

    },
    "TextEdit\0returnPressed\0\0returnshell"
};
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEdit::returnPressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TextEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEdit::returnshell)) {
                *result = 1;
                return;
            }
        }
